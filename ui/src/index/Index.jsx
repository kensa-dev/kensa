...
const Index = () => {
    ...
    const {titleText} = useContext(ConfigContext)
    ...
    return <>
        <Header titleText={titleText}>Index</Header>
        <section className="section">
            <nav className="block">
                <div className="field has-addons">
                    ...
                    <p className="control">
                        <button className="button is-info is-light" onClick={doFilter}>Search</button>
                    </p>
                </div>

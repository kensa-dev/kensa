...
[`FieldDslExamplesTest`](https://github.com/kensa-dev/clearwave-example/blob/master/src/test/kotlin/com/clearwave/fields/FieldDslExamplesTest.kt) in clearwave-example is annotated this way. The published [HTML report](https://clearwave.kensa.dev) shows the resulting on-hover hints over each field reference.

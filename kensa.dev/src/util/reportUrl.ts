...
const METHOD = encodeURIComponent('voice and broadband order is successfully completed');

export const orderServiceTestUrl = (base: string, theme: ReportTheme): string =>
    `${base}#/test/test::com.clearwave.OrderServiceTest?method=${METHOD}&theme=${theme}`;

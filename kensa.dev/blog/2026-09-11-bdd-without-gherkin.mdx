...
Because the report is generated, it can also carry what the feature file couldn't: the messages the test saw between services, their payloads, and a sequence diagram drawn from that traffic. The [Clearwave example report](https://clearwave.kensa.dev) is live if you want to see one.

...
Every screenshot here is from the [Clearwave example report](https://clearwave.kensa.dev), which is published and live. Go and click around it rather than taking my word for any of this.

...
extensions.getByType(JavaPluginExtension::class.java).registerFeature("testSupport") {
    ...
    capability("dev.kensa", "framework-junit6-test-support", "$version")
}
...
extensions.getByType(JavaPluginExtension::class.java).registerFeature("javaExample") {
    ...
    capability("dev.kensa", "framework-junit6-java-example", "$version")
}
...
extensions.getByType(JavaPluginExtension::class.java).registerFeature("kotlinExample") {
    ...
    capability("dev.kensa", "framework-junit6-kotlin-example", "$version")
}
...
dependencies {
    ...
    "testSupportApi"(platform(libs.junit6Bom))
    "testSupportApi"(libs.junit6JupiterEngine)
    "testSupportApi"(libs.junit6JupiterApi)
    "testSupportApi"(libs.junit6JupiterParams)
    "testSupportApi"(libs.junit6PlatformTestKit)
    "testSupportApi"(libs.junit6PlatformEngine)
    "testSupportApi"(libs.junit6PlatformLauncher)

    "javaTestImplementation"(project(":framework-junit6")) {
        capabilities {
            requireCapability("dev.kensa:framework-junit6-test-support")
        }
    }
    "javaTestImplementation"(project(":framework-junit6")) {
        capabilities {
            requireCapability("dev.kensa:framework-junit6-java-example")
        }
    }

    "kotlinTestImplementation"(project(":framework-junit6")) {
        capabilities {
            requireCapability("dev.kensa:framework-junit6-test-support")
        }
    }
    "kotlinTestImplementation"(project(":framework-junit6")) {
        capabilities {
            requireCapability("dev.kensa:framework-junit6-kotlin-example")
        }
    }

    "javaExampleImplementation"(project(":framework-junit6")) {
        capabilities {
            requireCapability("dev.kensa:framework-junit6-test-support")
        }
    }
    ...
    "javaExampleImplementation"(platform(libs.junit6Bom))
    "javaExampleImplementation"(libs.junit6JupiterApi)
    "javaExampleImplementation"(libs.junit6JupiterParams)
    ...
    "kotlinExampleImplementation"(project(":framework-junit6")) {
        capabilities {
            requireCapability("dev.kensa:framework-junit6-test-support")
        }
    }
    ...
    "kotlinExampleImplementation"(project(":core"))
    "kotlinExampleImplementation"(platform(libs.junit6Bom))
    "kotlinExampleImplementation"(libs.junit6JupiterApi)
    "kotlinExampleImplementation"(libs.junit6JupiterParams)
